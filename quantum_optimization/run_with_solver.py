...
from pipeline.main_with_solver import single_run_with_solver
...
def main():
    ...
    if len(sys.argv) != 2:
        logger.error("Usage: python run_with_solver.py <yaml_parameters_path>")
        sys.exit(1)
    ...
    output_dict = single_run_with_solver(parameter_dict)
